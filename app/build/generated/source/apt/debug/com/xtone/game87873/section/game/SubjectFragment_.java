...
public final class SubjectFragment_
    extends com.xtone.game87873.section.game.SubjectFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public static SubjectFragment_.FragmentBuilder_ builder() {
        return new SubjectFragment_.FragmentBuilder_();
    }
        ...
        if (btn_refresh!= null) {
            btn_refresh.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    SubjectFragment_.this.refreshClick();
                }
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<SubjectFragment_.FragmentBuilder_, com.xtone.game87873.section.game.SubjectFragment>
    {


        @Override
        public com.xtone.game87873.section.game.SubjectFragment build() {
            SubjectFragment_ fragment_ = new SubjectFragment_();
