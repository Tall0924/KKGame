    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        scannerViewfinder = ((ViewfinderView) hasViews.findViewById(id.scannerViewfinder));
        {
            View view = hasViews.findViewById(id.ll_lamp);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        CaptureActivity_.this.lampClick();
                    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CaptureActivity_.this.ivBackClick();
                    }
        ...
        {
            View view = hasViews.findViewById(id.tv_back);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CaptureActivity_.this.tvBackClick();
                    }
        ...
        {
            View view = hasViews.findViewById(id.ll_ablum);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CaptureActivity_.this.ablumClick();
                    }
