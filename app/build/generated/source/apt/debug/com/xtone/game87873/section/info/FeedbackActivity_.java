    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        lv_message = ((ListView) hasViews.findViewById(id.lv_message));
        ...
        edt_mobileOrEmail = ((EditText) hasViews.findViewById(id.edt_mobileOrEmail));
        if (iv_headLeft!= null) {
            iv_headLeft.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    FeedbackActivity_.this.backClick();
                }
        ...
        if (btn_submit!= null) {
            btn_submit.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    FeedbackActivity_.this.submitClick();
                }
