    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        btn_register = ((Button) hasViews.findViewById(id.btn_register));
        iv_user_icon = ((CircleImageView) hasViews.findViewById(id.iv_user_icon));
        tv_forgetPassword = ((TextView) hasViews.findViewById(id.tv_forgetPassword));
        btn_login = ((Button) hasViews.findViewById(id.btn_login));
        tv_headTitle = ((TextView) hasViews.findViewById(id.tv_headTitle));
        iv_headLeft = ((ImageView) hasViews.findViewById(id.iv_headLeft));
        edt_userName = ((EditText) hasViews.findViewById(id.edt_userName));
        edt_userPassword = ((EditText) hasViews.findViewById(id.edt_userPassword));
        if (tv_forgetPassword!= null) {
            tv_forgetPassword.setOnClickListener(new OnClickListener() {


                @Override
                public void onClick(View view) {
                    LoginActivity_.this.forgetPasswordClick();
                }
        ...
        if (btn_register!= null) {
            btn_register.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    LoginActivity_.this.registerClick();
                }
