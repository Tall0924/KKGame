...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_TEXT_SIZE = 10;// 增加的,字体大小，单位sp
	private static final int DEFAULT_MARGIN_DIP = 5;// 原来为5
	private static final int DEFAULT_LR_PADDING_DIP = 5;// 原来为5
	private static final int DEFAULT_CORNER_RADIUS_DIP = 8;// 原来为8
	private static final int DEFAULT_POSITION = POSITION_TOP_RIGHT;
	private static final int DEFAULT_BADGE_COLOR = Color
			.parseColor("#CCFF0000"); // Color.RED;
	// private static final int DEFAULT_TEXT_COLOR = Color.WHITE;
	private static final int DEFAULT_TEXT_COLOR = Color.parseColor("#CCFFFFFF");;
	...
	private ShapeDrawable getDefaultBackground() {
		...
		return drawable;
		// return
		// context.getResources().getDrawable(R.drawable.nav_index_downld_num);
