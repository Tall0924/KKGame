package com.xtone.game87873.zxing;
...
import com.xtone.game87873.zxing.decoding.CaptureActivityHandler;
import com.xtone.game87873.zxing.decoding.InactivityTimer;
import com.xtone.game87873.zxing.decoding.RGBLuminanceSource;
import com.xtone.game87873.zxing.decoding.Utils;
import com.xtone.game87873.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback {
	...
	@ViewById
	ViewfinderView scannerViewfinder;
...
//		}
	...
	//显示扫描内容
	private void showScanContent(String content){
		CommonDialog comDialog = new CommonDialog(CaptureActivity.this, new DialogInterface.OnClickListener() {
		...
		comDialog.setContent("结果："+content);
		comDialog.getBtn_cancle().setVisibility(View.GONE);
		comDialog.getBtn_ok().setText("确定");
		comDialog.show();
	}
